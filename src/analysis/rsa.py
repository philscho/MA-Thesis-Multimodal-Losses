...
def get_multimodal_rdm(reps_1: list, reps_2: list, metric: str = "cosine"):
    """
    Get an RDM with features from two different modalities
    Args:
        distance : argument for the pdist function of scipy to calculate the pdist
    """
    # assert reps is not None
    # assert reps != []
    return cdist(reps_1, reps_2, metric=metric)
